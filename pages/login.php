...
<div id="top_bar_black"> <div id="logo_container"> <div id="logo_image"> </div>  <div id="nav_block"> <a class="nav_button" href="../index.php"> Главная</a>
	  <?php if (isset($_COOKIE['user'])) { ?>  
        ...
        <div id="content_container">
            <?php if (isset($_COOKIE['user'])) { ?> 
            <div id="header"> <div class="header_content_mainline"> Вы уже авторизованы! </div> <div id="header_content_tagline"></div>
            <?php } else{?>
       	  <div id="header"> <div class="header_content_mainline"> Авторизация </div> <div id="header_content_tagline">Заполните форму авторизации</div>
          
          
</div>
           
                 <div id="header_lower">  <div id="header_content_boxline">Войти <div id="header_content_boxcontent">
                             ...
                             <input name="sub_login" type="submit" value="Отправить"/>
                             </form>
                             <?php echo $error ?>
 </div></div> 
                     <?php } ?>
